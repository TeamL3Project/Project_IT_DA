...
<body>
	<div class="wrapper" style="width: 1250px; display: flex " align="center;">
		<div class="info">
			<div class="test" style="border: 1px solid black; width: 1000px; height:500px; display: flex">
			...
			<img src="../image/channel/ccc.jpg" style="width: 330px; height: 300px; border-bottom-left-radius: 50px;"> <br>
			<button class="btn bt-item bt-hover">구독하기</button>

			<img src="../image/channel/alram.png" style="width: 40px; height: 40px; margin-left: 10px;">
		</div>
			</div>
