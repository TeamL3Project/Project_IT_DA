...
<body>
	<div class="wrapper">
		<div class="topInfo">
			<br> <br>
			<div class="info">
				<h3 style="margin: 0 3; padding: 0 0 18;">[책장 위 고양이]</h3>
				<div id="profile1" style="margin: -20;">
					...
					<img src="../image/channel/ccc.jpg"
						style="width: 360; height: 320; border-bottom-left-radius: 50px; padding: 10;">
					<br>
					<div class="sub_alram_btn"
						style="padding: 30; margin-top: -38; padding-left: 15;">
